...
//    if ($session == "") { //validamos que no tenga sesión abierta en otro navegador
        ...
        $_SESSION['loggedin_1'] = true;
        $_SESSION['usu_1'] = $user;
        $_SESSION['name_1'] = $result['Name1'] . ' ' . $result['Surname1'];
        $_SESSION['start_1'] = date('Y-m-d H:i:s');
        $_SESSION['state_1'] = 'login';
        $_SESSION['workgroup_1'] = $result['UserGroup'];
        $_SESSION['idSession_1'] = $idSession;
        $_SESSION['Identification_1'] = $result['Identification'];
        $_SESSION['Region_1'] = $result['Region'];
        $_SESSION['Agencias_1'] = $result['Agencias'];
